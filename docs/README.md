...
2. **[APT模型手册](APT_MODEL_HANDBOOK.md)** - 完整的模型使用手册
3. **[启动器使用指南](LAUNCHER_README.md)** - GUI启动器使用说明
...
- **[知识蒸馏原理](DISTILLATION_PRINCIPLE.md)**
  - 知识蒸馏的理论基础
  - 温度调节和软标签
  - 损失函数设计

- **[Teacher API指南](TEACHER_API_GUIDE.md)**
  - 外部API作为教师模型
  - 支持OpenAI、Anthropic、SiliconFlow等
  - 成本追踪和管理

- **[视觉蒸馏指南](VISUAL_DISTILLATION_GUIDE.md)**
  - 多模态知识蒸馏
  - 图像-文本对齐学习
...
- **[RL与预训练完整指南](RL_PRETRAINING_GUIDE.md)**
  - 奖励模型训练
  - RLHF (PPO-based)
...
- **[GraphRAG模块文档](../apt_model/core/graph_rag/)**
  - [快速开始](../apt_model/core/graph_rag/START_HERE.md)
  - [项目结构](../apt_model/core/graph_rag/PROJECT_STRUCTURE.md)
  - [集成指南](../apt_model/core/graph_rag/INTEGRATION.md)
  - [完整文档](../apt_model/core/graph_rag/README.md)

### 🎯 微调与优化

- **[微调指南](FINE_TUNING_GUIDE.md)**
  - LoRA微调
  - 全参数微调
  - 参数高效微调方法
...
- **[API Provider统一接口](API_PROVIDERS_GUIDE.md)**
  - OpenAI API
  - Anthropic API
  - SiliconFlow API
  - 自定义API
...
#### 🟢 初级 (入门必读)
1. [项目主文档](../README.md)
2. [启动器使用指南](LAUNCHER_README.md)
3. [APT模型手册](APT_MODEL_HANDBOOK.md)
4. [微调指南](FINE_TUNING_GUIDE.md)

#### 🟡 中级 (进阶使用)
1. [知识蒸馏原理](DISTILLATION_PRINCIPLE.md)
2. [Teacher API指南](TEACHER_API_GUIDE.md)
3. [知识图谱指南](KNOWLEDGE_GRAPH_GUIDE.md)
4. [Optuna优化](OPTUNA_GUIDE.md)
...
### 我想训练一个小模型
1. 阅读 [微调指南](FINE_TUNING_GUIDE.md)
2. 使用 [启动器](LAUNCHER_README.md) 快速开始
3. 参考 [APT模型手册](APT_MODEL_HANDBOOK.md)

### 我想使用大模型API做知识蒸馏
1. 阅读 [知识蒸馏原理](DISTILLATION_PRINCIPLE.md)
2. 配置 [Teacher API](TEACHER_API_GUIDE.md)
3. 查看 [API Provider指南](API_PROVIDERS_GUIDE.md)

### 我想做强化学习训练
1. 阅读 [RL完整指南](RL_PRETRAINING_GUIDE.md)
2. 选择算法: RLHF / DPO / GRPO
3. 运行示例: [DPO示例](../examples/rl_examples/dpo_example.py)

### 我想构建知识图谱系统
1. 阅读 [知识图谱指南](KNOWLEDGE_GRAPH_GUIDE.md)
2. 参考 [GraphRAG快速开始](../apt_model/core/graph_rag/START_HERE.md)
3. 运行 [GraphRAG示例](../examples/graph_rag_examples/basic_usage.py)

### 我想监控训练过程
1. 阅读 [SOSA快速开始](../apt_model/core/training/QUICK_START.md)
2. 参考 [完整文档](../apt_model/core/training/README.md)
