...
def __getattr__(name):
    ...
    if name == "APTLargeModel":
        from apt.apt_model.modeling.apt_model import APTLargeModel as _APTLargeModel

        return _APTLargeModel

    if name == "MultimodalAPTModel":
        from apt.apt_model.modeling.multimodal_model import (
    ...
    if name == "train_model":
        try:
            from apt.apt_model.training.trainer import train_model as _train_model
