...
使用方法：
    # 方法1：显式调用
    import apt.perf.optimization.vb_autopatch as vb_patch
    vb_patch.patch_apt_models()

    # 方法2：导入即生效
    import apt.perf.optimization.vb_autopatch  # 自动patch
...
if __name__ == "__main__":
    ...
    print("```python")
    print("# 方法1：手动patch")
    print("import apt.perf.optimization.vb_autopatch as vb_patch")
    ...
    print("from apt.apt_model.modeling.apt_model import APTLargeModel")
