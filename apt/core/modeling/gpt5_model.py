...
Refactored to use unified VFT/TVA modules from apt.core.modeling.blocks
"""
...
from apt.core.modeling.blocks import VeinProjector
...
# ================== embed =================
# Note: VeinProjector now imported from apt.core.modeling.blocks
