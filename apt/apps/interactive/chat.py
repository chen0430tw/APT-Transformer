...
from apt.core.generation.generator import generate_natural_text, safe_decode
...
def chat_with_model(
    ...
    try:
        ...
        if tokenizer_type:
            ...
            try:
                from apt.model.tokenization.chinese_tokenizer_integration import load_tokenizer
                # 首先检查是否有保存的分词器配置
