...
def _register_all_plugins():
    ...
    # 中文插件
    def create_zh_char():
        from apt_model.codecs.plugins.zh_char import ZhCharCodec
    ...
    # 英文插件
    def create_en_gpt2():
        from apt_model.codecs.plugins.en_gpt2 import EnGPT2Codec
        from apt.core.codecs import CodecConfig
    ...
    # 日文插件（占位）
    def create_ja_mecab():
        from apt_model.codecs.plugins.ja_mecab import JaMecabCodec
        from apt.core.codecs import CodecConfig
